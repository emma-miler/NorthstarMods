...
void function SetupComboButtonTest( var menu )
{
	...
	file.joinInviteButton = AddComboButton( comboStruct, headerIndex, buttonIndex++, "#NS_INVITE_JOIN_BUTTON" )
	Hud_AddEventHandler( file.joinInviteButton, UIE_CLICK, AdvanceMenuEventHandler( GetMenu( "JoinInviteMenu" ) ) )
